...
export const EvolutionTimeline: React.FC<EvolutionTimelineProps> = ({ stages, activeIndex, onStageChange }) => {
  return (
    <div className="w-full relative">
      {/* A linha contínua que se estende por toda a largura da coluna de 70% */}
      <div className="absolute top-1/2 left-0 w-full h-px bg-white -translate-y-1/2"></div>
      
      {/* Container para os pontos que aplica o padding do site */}
      <div className="relative w-full px-8 lg:px-16">
        {/* Sub-container que define a largura de 3/4 para os pontos */}
